                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="text-left mt-2">
                                                <form action="{{ route('caterings.destroy', $catering->id) }}" method="POST" class="d-inline">
                                                    <a class="btn btn-primary btn-sm" href="{{ route('caterings.edit', $catering->id) }}" title="Edit">
