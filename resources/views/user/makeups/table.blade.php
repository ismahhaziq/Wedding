                            ...
                            <div class="card-body">
                                    ...
                                    <div id="makeupCarousel" class="carousel slide mb-4" data-bs-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img src="{{ asset('./img/dress1.jpg') }}" class="d-block w-100 h-100"
                                                    style="object-fit: cover;" alt="Slide 1">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="{{ asset('./img/dress2.png') }}" class="d-block w-100 h-100"
                                                    style="object-fit: cover;" alt="Slide 2">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="{{ asset('./img/dress3.png') }}" class="d-block w-100 h-100"
                                                    style="object-fit: cover;" alt="Slide 2">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="{{ asset('./img/dress4.png') }}" class="d-block w-100 h-100"
                                                    style="object-fit: cover;" alt="Slide 2">
                                            </div>
                                        </div>
                                        <button class="carousel-control-prev" type="button"
                                            data-bs-target="#makeupCarousel" data-bs-slide="prev">
                                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Previous</span>
                                        </button>
                                        <button class="carousel-control-next" type="button"
                                            data-bs-target="#makeupCarousel" data-bs-slide="next">
                                ...
                                <div class="card-header pb-0">
                                    <div class="d-flex justify-content-between align-items-center"
                                        ...
                                        <a href="{{ route('makeups.dress') }}" class="btn btn-primary btn-sm">View
                                            Dresses</a>
                                    </div>
                                </div>
                                ...
                                <div class="larger-image-container">
                                    <img src="{{ asset('storage/' . $makeup->image) }}" class="avatar me-3"
                                        alt="Current Image">
                                </div>
                                @endif
                                <!-- Makeup Title -->
                                <h5 class="text-black-bold p-2" style="margin-left: -10px"> {{ $makeup->title }} </h5>
                                ...
                                <form action="{{ route('makeups.addToInvoice', $makeup->id) }}" method="POST"
                                    class="d-inline">
                                    @csrf
