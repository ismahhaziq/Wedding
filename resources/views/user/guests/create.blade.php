...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Create New Guest'])
                ...
                <div class="card-body px-4 pt-4">
                    <form action="{{ route('guests.store') }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="relatives" name="relatives" value="{{ old('relatives') }}" required>
                        </div>
